...
# 1. Expand into a complete 69-phenotype framework plus a misc fallback.
...
class SleepAnimalServiceV2
  ...
  PHENOTYPE_GROUPS = {
    ...
    circadian_and_schedule: %i[
      ...
      gazelle_jet_lag_hopper bat_shift_worker wolf_delayed_clock
  ...
  PHENOTYPES = {
    ...
    bat_shift_worker: phenotype_data(
      ...
      description: "Shift work or rotating schedules can make sleep feel fragmented, mistimed, or always slightly off. You may do everything right and still feel like your body clock is pushing back. That does not mean there is no solution. It means you need tools designed for circadian disruption, not generic sleep advice.",
    ...
    eagle_advanced_clock: phenotype_data(
      ...
      description: "This profile reflects a stronger advanced circadian pattern. You may get sleepy early, wake very early, and feel like the end of the night comes before you are finished recovering. The key is to respect the strength of your timing signal while deciding where it needs support. Tiny changes in light and routine can matter a lot here.",
    ...
    mole_free_running_clock: phenotype_data(
      ...
      description: "This phenotype fits when sleep timing keeps sliding rather than staying anchored to a stable day. It can feel like your sleep schedule keeps moving out from under you, making routines harder to trust. The goal is to reintroduce strong anchors that tell the circadian system what day and night are supposed to mean.",
    ...
    walrus_thunder_snorer: phenotype_data(
      ...
      description: "You may be someone whose nights sound more disrupted than they look. Even when snoring is not severe apnea, it can still point to airway resistance, dry sleep, or poorer overnight restoration. Many people underestimate how much snoring affects recovery until they improve it. Small changes can matter, and persistent symptoms deserve follow-up.",
    ...
    meerkat_noise_guard: phenotype_data(
      ...
      description: "You seem highly sensitive to noise, light, or environmental unpredictability. Instead of fully powering down, your system keeps monitoring the space around you, which can make sleep lighter and more fragmented. This is especially common when you are stressed or sleeping in a noisy environment. Better sleep for you usually begins with making the room feel more predictable and safe.",
    ...
    bear_consistent_restorer: phenotype_data(
      ...
      description: "Your pattern looks steady, restorative, and aligned with your needs. That does not mean you are done. It means you have a strong base to protect and optimize. The biggest opportunity for you is to stay consistent and make small changes that strengthen recovery even more.",
    ...
    dog_flexible_sleeper: phenotype_data(
      ...
      description: "You seem able to sleep reasonably well without needing perfect conditions every single night. That flexibility is a strength. It often means your baseline recovery system is solid. Your best next step is to make sure flexibility does not slowly turn into inconsistency.",
    ...
    lion_deep_sleep_athlete: phenotype_data(
      ...
      description: "This phenotype fits people who push hard physically and then drop into unusually restorative sleep. You may train intensely, stay highly active, or demand a lot from your body during the day, but your nights appear to answer with deep, efficient recovery. The opportunity here is not fixing broken sleep. It is preserving the habits that let high output and deep restoration reinforce each other.",
    ...
    crane_zen_meditator: phenotype_data(
      ...
      description: "This pattern fits people who use meditation, mindfulness, breathwork, or similar practices to create unusually calm and restorative sleep. Your nights may feel spacious, steady, and less reactive than average because you have taught your nervous system how to settle. That is a meaningful strength. The next step is to preserve the rituals and timing that let that calm translate into real biological recovery.",
    ...
    peacock_sleep_paralysis: phenotype_data(
      ...
      description: "This profile fits episodes of waking awareness with temporary inability to move, often paired with vivid sensations or fear. These experiences can make sleep feel less safe even when the rest of the night looks normal. The goal is to reduce instability around sleep transitions and lower the fear they create.",
    ...
    shark_half_alert: phenotype_data(
      ...
      description: "This profile reflects a mix of physiologic and environmental alertness. Sleep may happen, but it feels guarded, shallow, or easy to fracture. People in this category often wake tired despite enough time in bed because the system never fully surrenders into rest. The next step is reducing threat signals from both body and environment.",
    ...
    platypus_dream_actor: phenotype_data(
      ...
      description: "This profile fits nights with dream enactment, physical movement, or unusually active REM-related behavior. Even when episodes are occasional, they can make sleep feel less predictable and sometimes less safe. The main goal is to reduce risk, improve sleep stability, and understand whether the pattern is intensifying.",
    ...
    phoenix_rebound_sleeper: phenotype_data(
      ...
      description: "This profile reflects a cycle of under-sleeping followed by catch-up behavior, long sleeps, naps, or heavy fatigue swings. Rebound recovery can help in the short term, but it also keeps the system unstable if it becomes the norm. What your body wants is not another heroic reset. It wants a steadier baseline.",
    ...
    bee_stress_sensitive: phenotype_data(
      ...
      description: "This profile fits people whose sleep is highly responsive to workload, emotional strain, or periods of overwhelm. Sleep may be decent in calm seasons and much worse in demanding ones. That is useful to know, because it means your sleep system is sensitive, not random. The best plan is one that becomes more supportive before stress peaks, not after.",
    ...
    ostrich_escape_sleeper: phenotype_data(
      ...
      description: "This profile fits people who delay bed, dread the attempt to sleep, or avoid nighttime because sleep has become emotionally loaded. The issue is not laziness. It is that bedtime itself has started to feel like pressure. The right next step is to make the approach to sleep feel less threatening and more winnable.",
    ...
    crab_back_sleeper: phenotype_data(
      ...
      description: "This profile fits people whose nights seem noticeably worse on their back. Position can change snoring, airway resistance, and how restored sleep feels the next morning. That is useful because position-related problems are often more modifiable than they first appear.",
    ...
    rhino_explosive_snorer: phenotype_data(
      ...
      description: "This profile fits very loud, forceful snoring patterns that may be affecting both your sleep and your bed partner's. Even if the issue is normalized socially, it can still signal meaningful airway strain. The key is to take the noise seriously as a recovery clue.",
    ...
    alligator_bruxing_breather: phenotype_data(
      ...
      description: "This overlap profile fits people whose nights include both clenching or grinding and airway-like sleep disruption. The combination can leave mornings feeling tense, dry, or under-recovered. It is a useful pattern to name because it often hides in plain sight.",
    ...
    boar_alcohol_airway: phenotype_data(
      ...
      description: "This profile fits sleep that becomes noticeably worse after drinking, especially when snoring, breathing, or fragmentation are already in the picture. Alcohol can make sleep feel easier at first while quietly reducing quality later in the night. The best move is to treat that effect as data, not as a personality flaw.",
    ...
    sea_lion_central_breather: phenotype_data(
      ...
      description: "This profile is reserved for central or atypical breathing-disruption histories where sleep feels unstable for reasons beyond classic snoring. The night may feel broken, unrefreshing, or strangely effortful without the usual clues. Naming the pattern helps keep the follow-up appropriately specific.",
    ...
    seal_seasonal_adapter: phenotype_data(
      ...
      description: "This profile fits people whose sleep timing or quality noticeably changes with season, daylight, weather, or time-of-year routine shifts. The important takeaway is that your sleep may be more light-sensitive than average. That gives you something to work with, not just something to endure.",
    ...
    sloth_high_sleep_need: phenotype_data(
      ...
      description: "This is the stronger end of the long-sleep-need spectrum. If you consistently function best with a long sleep opportunity, that matters. The key is not to pathologize the need automatically. It is to support it well and make sure the extra time is delivering real recovery.",
    ...
    hummingbird_micro_recovery: phenotype_data(
      ...
      description: "This profile fits short sleep windows, fragmented nights, or a life structure that forces recovery into small pieces. It is not the same as naturally needing less sleep. It is a body trying to stay afloat on micro-recovery. The best move is to make those pieces more efficient while working toward something steadier.",
    ...
    raccoon_night_worker: phenotype_data(
      ...
      description: "This profile is a more specific version of shift-work disruption. It fits people whose actual work hours occupy the night and force sleep into daylight or irregular margins. The challenge is not just timing. It is that your schedule repeatedly asks sleep to happen against strong biological resistance.",
    ...
    vulture_grief_sleeper: phenotype_data(
      ...
      description: "This profile fits people whose sleep changed in the context of grief, loss, or a major emotional rupture. Nights may feel heavy, restless, lonely, or unexpectedly wide awake. This kind of sleep disruption is not just a habit problem. It is an understandable response to a system under emotional strain.",
    ...
    squirrel_stress_triggered: phenotype_data(
      ...
      description: "This profile fits people whose sleep deteriorates quickly under acute stress, deadlines, uncertainty, or conflict. The key insight is that your sleep system seems especially responsive to trigger loads. That means prevention and early intervention matter more than late rescue.",
